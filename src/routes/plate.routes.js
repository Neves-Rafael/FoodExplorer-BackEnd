...
platesRoutes.post('/',verifyRoleAuthorization('admin'), platesController.create);

platesRoutes.get('/', platesController.index);
platesRoutes.get('/:id', platesController.show);

platesRoutes.put('/:id',verifyRoleAuthorization('admin'), platesController.update);
platesRoutes.delete('/:id', verifyRoleAuthorization('admin'), platesController.delete);
